 ...
 */
/**
 * The Facebook Pages faker — the PHP twin of the js package's `src/faker.ts`.
 *
 ...
 * than a convenience.
 */
final class FacebookPagesFaker
{
    ...
    {
        $boundPostid = implode('', array_map(static fn (): int => $fake->int(0, 9), range(1, 15)));
