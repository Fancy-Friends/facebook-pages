 ...
 */
/**
 * Every Facebook Pages node executor — the PHP twin of
 * `FACEBOOK_PAGES_RUNNABLE_KINDS` in @particle-academy/facebook-pages-js.
 *
 * Each class declares its kind in a `#[FlowNode]` attribute. Two ways onto a
 * host:
 *
 * - `FacebookPagesFlow::register($kinds, $executors)` — one call, no directory
 * scan.
