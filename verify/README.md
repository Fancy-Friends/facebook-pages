...
| Registry | Package |
|---|---|
| npm | `@particle-academy/facebook-pages-js` (+ `@particle-academy/facebook-pages-ui`, resolved transitively) |
...
npm install @particle-academy/facebook-pages-js @particle-academy/fancy-flow
